...
export class TextureArray {
    ...
    constructor(width, height, depth) {
        ...
        gl.texImage3D(gl.TEXTURE_2D_ARRAY, 0, gl.RGBA, this.width, this.height, this.depth, 0, gl.RGBA, gl.UNSIGNED_BYTE, pixels);
    ...
    setImage(image, index) {
        ...
        gl.bindTexture(gl.TEXTURE_2D_ARRAY, this.handle);
        gl.texSubImage3D(gl.TEXTURE_2D_ARRAY, 0, 0, 0, index, this.width, this.height, 1, gl.RGBA, gl.UNSIGNED_BYTE, image);
    }
}
//# sourceMappingURL=texturearray.js.map